...
const Banner = () => {
  return (
    <Section>
        <ImgContainer>
        <img src={img1} width="500" height="400"  alt="Me Mes" />
        <img src={img2} width="500" height="400"  alt="Me Mes" />
        <img src={img3} width="500" height="400"  alt="Me Mes" />
        <img src={img4} width="500" height="400"  alt="Me Mes" />
        <img src={img5} width="500" height="400"  alt="Me Mes" />
